df <- readRDS("simulation/day_model/simulation_results2.rds")
...
ggplot2::ggsave("simulation/day_model/parameter_recovery2.pdf", p,
                width = 6, height = 4)
...
ggplot2::ggsave("simulation/day_model/parameter_recovery_ic2.pdf", p_ic,
                width = 10, height = 4)
