...
source("simulation/day_model/utils2.R")

evq <- parallel::clusterEvalQ(clus, source("simulation/day_model/utils2.R"))

modelout <- paste0("simulation/day_model/modelout2")

load("simulation/day_model/simulation_settings2.RData")
...
m_stan <- rstan::stan_model("simulation/day_model/day_model.stan")
for (days in n_days) {
  for(beeps in n_beeps) {
